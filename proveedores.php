...
$nameSession = "catalogoProveedores";
$arrayFilter = array();
$session = new PaginadorSession("prv.nombre", "prv.nombre", $nameSession, $arrayFilter, "Filtro");
...
$conditions = "prv.cia = " . $usuarioSesion->getCia();
if ($Filtro !== "Todos") {
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Proveedor=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
