...
$arrayFilter = array("Filtro" => "Todos");
$session = new PaginadorSession("cli.nombre", "cli.nombre", $nameSession, $arrayFilter, "Filtro");
...
$conditions = "cli.cia = " . $usuarioSesion->getCia();
if ($Filtro !== "Todos") {
    $conditions = " AND cli.tipodecliente LIKE '%$Filtro%'";
}
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Cliente=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
