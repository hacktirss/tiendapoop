...
$arrayFilter = array();
$session = new PaginadorSession("ing.id", "ing.id", $nameSession, $arrayFilter, "Filtro");
...
$paginador = new Paginador($Id,
        "",
        "LEFT JOIN est ON ing.cuenta = est.id",
        "",
        "$conditions",
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Ingreso=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
