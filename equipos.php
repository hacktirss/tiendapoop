...
$nameSession = "catalogoEquipos";
$arrayFilter = array();
$session = new PaginadorSession("equipos.grupo", "equipos.grupo", $nameSession, $arrayFilter, "Filtro");
...
$conditions = "equipos.cia = " . $usuarioSesion->getCia();
if ($Filtro !== "Todos") {
...
$paginador = new Paginador($Id,
        "equipos.id",
        "LEFT JOIN grupos ON grupos.id = equipos.grupo",
        "",
        "$conditions",
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Equipo=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
