...
$arrayFilter = array();
$session = new PaginadorSession("inv.descripcion", "inv.descripcion", $nameSession, $arrayFilter, "Filtro");
...
$conditions = "inv.cia = " . $usuarioSesion->getCia();
if ($Filtro !== "Todos") {
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Producto=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
