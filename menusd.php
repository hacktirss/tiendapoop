...
$session = new PaginadorSession("submenus.id", "submenus.id", $nameSession, $arrayFilter, DETALLE);
...
$Id = 96;
$Titulo = "Configuracion de Submenus";

$conditions = "submenus.menu = '" . $cVarVal . "'";
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Submenu=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
