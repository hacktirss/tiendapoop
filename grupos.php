...
$nameSession = "catalogoGrupos";
$arrayFilter = array();
$session = new PaginadorSession("g.id", "g.id", $nameSession, $arrayFilter, "Filtro");
...
$Id = 82;
$Titulo = "Catalogo de grupos";

$conditions = "g.cia = " . $usuarioSesion->getCia();
if ($Filtro !== "Todos") {
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Grupo=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
