...
$registros = utils\ConnectionUtils::getRowsFromQuery($selectCxc, conectarse());
?>
    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#Referencia").prop("placeholder", "F-00000");
                $("#Importe").prop("placeholder", " 0.00");
                                            ...
                                            <td colspan="100%">
                                                <div class="container">
                                                    <div class="row no-gutters">
                                                        ...
                                                        <div class="col-1 align-right">Referencia:</div>
                                                        <div class="col-1"><input type="text" name="Referencia" id="Referencia"></div>
                                                        <div class="col-1 align-right">Abono $</div>
                                                        <div class="col-1"><input type="text" name="Importe" id="Importe"></div>
                                                        <div class="col-1"></div>
                                                        <div class="col-1"><input type="submit" name="Boton" value="Enviar"></div>
                                                        <div class="col-1"></div>
                                                        <div class="col-1"><input type="submit" name="Boton" value="Historico"></div>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
