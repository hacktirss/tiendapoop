...
$arrayFilter = array();
$session = new PaginadorSession("qrys.nombre", "qrys.nombre", $nameSession, $arrayFilter, "Filtro");
...
$Id = 1;
$Titulo = "Configuracion de Querys";
                    ...
                    while ($paginador->next()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <?php else: ?>
                                    <a href="<?= $rLink . "?busca=NUEVO&Query=" . $row["id"] ?>" data-id="<?= $row["id"] ?>"><i aria-hidden="true" class="icon fa fa-lg fa-check"></i></a>
                                <?php endif; ?>
                            </td>
